Source: https://docs.slack.dev/reference
...
## Particularly popular pages {#particularly-popular-pages}

The most visited reference pages are those for [methods](/reference/methods), [events](/reference/events), and [scopes](/reference/scopes). They're the foundation of all Slack apps.
...
[Browse methods](/reference/methods)
...
[Browse events](/reference/events)
...
[Browse scopes](/reference/scopes)