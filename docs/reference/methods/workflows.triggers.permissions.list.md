...
# workflows.triggers.permissions.list method
...
Fetch the permission type and the entities that have been granted access to the [trigger](/tools/deno-slack-sdk/guides/creating-link-triggers), if type is 'named\_entities'.
...
```
{  "ok": true,  "permission_type": "app_collaborators",  "user_ids": [    "U01565LTEBD"  ]}
```
