Source: https://docs.slack.dev/reference/methods/admin.inviteRequests.denied.list

# admin.inviteRequests.denied.list method
...
```
POST https://slack.com/api/admin.inviteRequests.denied.list
```
...
This [invite request management API](/admins/managing-invite-requests) method lists workspace invite requests that have already been denied.
