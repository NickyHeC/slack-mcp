Source: https://docs.slack.dev/reference/methods/admin.auth.policy.removeEntities

# admin.auth.policy.removeEntities method
...
```
POST https://slack.com/api/admin.auth.policy.removeEntities
```

[![bolt-js](/img/logos/bolt-js-logo.svg)](/tools/bolt-js)

```
app.client.admin.auth.policy.removeEntities
```

[![bolt-py](/img/logos/bolt-py-logo.svg)](/tools/bolt-python)

```
app.client.admin_auth_policy_removeEntities
```

[![bolt-java](/img/logos/bolt-java-logo.svg)](/tools/java-slack-sdk/guides/getting-started-with-bolt)

```
app.client().adminAuthPolicyRemoveEntities
```
