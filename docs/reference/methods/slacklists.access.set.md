...
### Grant channel read access {#channel-read-access}

```
{  "token": "***",  "list_id": "F1234567",  "access_level": "read",  "channel_ids": ["C7654321"]}
```

### Grant user read access {#user-read-access}

```
{  "token": "***",  "list_id": "F1234567",  "access_level": "read",  "user_ids": ["U012A34BCDE"]}
```
