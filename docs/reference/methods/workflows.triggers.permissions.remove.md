...
# workflows.triggers.permissions.remove method

DocsCall generator

## Facts {#facts}

**Description**Revoke an entity's access to a trigger that has its permission type set to named\_entities
...
```
{  "ok": true,  "permission_type": "named_entities",  "user_ids": [    "U014KLZE350",    "U01565LTEBD"  ],  "channel_ids": [    "C014LMDP71R"  ]}
```
...
This trigger requires permission\_type to be set as named\_entities before adding users.
