...
This method is used to query a datastore and uses a [DynamoDB](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.OperatorsAndFunctions.html) style of syntax. The following example would retrieve all records from the "good\_tunes" datastore where "You" is in the song title.
...
```
{  "ok": true,  "datastore": "good_tunes",  "items": [    {      "artist": "Whitney Houston",      "song": "I Will Always Love You",      "id": "4"    },    {      "artist": "Fred Rogers",      "song": "Won't You Be My Neighbor?",      "id": "5"    }  ]}
```
