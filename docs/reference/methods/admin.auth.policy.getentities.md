Source: https://docs.slack.dev/reference/methods/admin.auth.policy.getEntities

# admin.auth.policy.getEntities method
...
```
POST https://slack.com/api/admin.auth.policy.getEntities
```

[![bolt-js](/img/logos/bolt-js-logo.svg)](/tools/bolt-js)

```
app.client.admin.auth.policy.getEntities
```

[![bolt-py](/img/logos/bolt-py-logo.svg)](/tools/bolt-python)

```
app.client.admin_auth_policy_getEntities
```

[![bolt-java](/img/logos/bolt-java-logo.svg)](/tools/java-slack-sdk/guides/getting-started-with-bolt)

```
app.client().adminAuthPolicyGetEntities
```
...
```
{  "ok": true,  "entities": [    {      "entity_type": "USER",      "entity_id": "U1234",      "date_added": 1620836993    }  ],  "entity_total_count": 1}
```
...
The `policy_name` could not be found.
